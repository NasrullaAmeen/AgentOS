...
Reusable templates for common `/os` research tasks. Agents read the matching template at the start of a run to calibrate scope, output format, and source priority.
